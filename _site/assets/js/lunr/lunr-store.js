var store = [{
        ...
        "excerpt":"Personal Project Fall, 2024 I made this controller as something of a cross between fun design challenge, and an art project. Leverless arcade controllers that opt for directional buttons over a joystick allow for greater precision when performing a quick series of directional inputs. This can significantly reduce user error...","categories": [],
        "tags": [],
        ...
        "excerpt":"R&amp;D Engineering Internship, Spryte Medical Summer 2024 Autoshrink Overview Explain the purpose of the Autoshrink in the 002896 subassembly manufacturing process Programmed physical feature detection tools to measure the positions of cathether probe components, and show an OK readout when components are properly aligned. Probe Assembly Process Put the solidworks...","categories": [],
        "tags": [],
        ...
        "excerpt":"&lt;p&gt;Mechanical Engineering Co-op, Teradyne Spring, 2023&lt;/p&gt; I designed this pneumatic lifecycle test fixture during my Spring 2023 Mechanical Engineering Co-op at Teradyne. Overview A plastic pin connector bracket was identified to have a high defect rate in Teradyne’s Ultraflex machines. Working with a senior engineer, a new material was selected...","categories": [],
        "tags": [],
